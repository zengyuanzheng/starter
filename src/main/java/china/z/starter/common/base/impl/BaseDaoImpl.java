package china.z.starter.common.base.impl;

import china.z.starter.common.base.IBaseDao;
import china.z.starter.common.util.UPageUtil;
...
public class BaseDaoImpl<T> implements IBaseDao<T> {
    ...
    public T load(String uuid) {
        return (T) getSession().load(getEntityClass(), uuid);
    }
    ...
    public T get(String uuid) {
        return (T) getSession().get(getEntityClass(), uuid);
    }
     ...
     * @return
     */
    public UPageUtil<T> findPageByFetchedHql(String hql, String countHql, int pageNo, int pageSize, Object... values) {
        UPageUtil<T> pageResults = new UPageUtil<T>();
        Query query = createHqlQuerys(hql, values);
